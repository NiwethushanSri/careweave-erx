...
export default function PatientSummaryPDF() {
  ...
  return (
    <div>
      ...
      <div className="max-w-2xl mx-auto p-8 bg-white" id="summary-pdf">
        {/* Header */}
        <div className="border-b-2 border-green-600 pb-5 mb-6">
        ...
        {doctors.length > 0 && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3 flex items-center gap-2">
              <span className="w-1 h-4 bg-green-600 rounded inline-block" /> Doctors Visited
            </h2>
        ...
        {diseases.length > 0 && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3 flex items-center gap-2">
              <span className="w-1 h-4 bg-blue-500 rounded inline-block" /> Diagnosis History
            </h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
        ...
        {medicines.length > 0 && (
          <div className="mb-6">
            <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3 flex items-center gap-2">
              <span className="w-1 h-4 bg-purple-500 rounded inline-block" /> Medicine History
            </h2>
            <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="mb-6">
          <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wide mb-3 flex items-center gap-2">
            <span className="w-1 h-4 bg-amber-500 rounded inline-block" /> Prescription History
          </h2>
          <table className="w-full text-sm border border-gray-200 rounded-lg overflow-hidden">
